    ...
    return (
        <div className="relative pt-48 pb-12 z-10 xl:pt-60 sm:pb-16 lg:pb-32 w-full xl:pb-48 2xl:pb-56 w-full">
            <div className='relative px-6 pt-10 sm:pt-4 md:px-0 -top-30  z-1000 bg-transparent w-full'>
                <h1 className='text-white text-center text-xl md:text-5xl font-mono font-thin '>Take the road towards the life with <br /> <span className=' text-2xl sm:text-6xl font-stretch-condensed italic font-bold animate-spin'>Tripora-AI</span></h1>
            ...
            <div className="absolute inset-0 ">
                <img className="brightness-40 object-cover w-screen h-screen" src="https://images.pexels.com/photos/2174656/pexels-photo-2174656.jpeg" alt="" />
            </div>

            <div className='relative -bottom-80 sm:-bottom-90 md:-bottom-84 text-center'>
