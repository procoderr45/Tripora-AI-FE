    ...
    return (
        <div className="relative pt-48 pb-12 z-10 xl:pt-60 sm:pb-16 lg:pb-32 w-full xl:pb-48 2xl:pb-56 w-full">
            <div className='relative px-6 pt-10 sm:pt-4 md:px-0 -top-30  z-1000 bg-transparent w-full'>
                <h1 className='text-white text-center text-5xl font-mono font-thin '>Take the road towards the life with <br /> <span className=' text-6xl font-stretch-condensed italic font-bold animate-spin'>Tripora-AI</span></h1>
            ...
            <div className='relative -bottom-85 sm:-bottom-110 md:-bottom-120 text-center'>
